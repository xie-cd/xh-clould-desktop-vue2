...
function loadtime() {
    let d = new Date();
    $('#s-m-r>.row1>.tool>.date').text(`星期${[null, '一', '二', '三', '四', '五', '六', '日'][d.getDay()]}, ${d.getFullYear()}年${d.getMonth().toString().padStart(2, '0')}月${d.getDate().toString().padStart(2, '0')}日`);
    $('#s-m-r>.row1>.tool>.time').text(`${d.getHours().toString().padStart(2, '0')}:${d.getMinutes().toString().padStart(2, '0')}:${d.getSeconds().toString().padStart(2, '0')}`);
    $('.dock.date>.date').text(`${d.getFullYear()}/${d.getMonth().toString().padStart(2, '0')}/${d.getDate().toString().padStart(2, '0')}`);
    $('.dock.date>.time').text(`${d.getHours().toString().padStart(2, '0')}:${d.getMinutes().toString().padStart(2, '0')}:${d.getSeconds().toString().padStart(2, '0')}`);
}
...
function showwin(name) {
    ...
    $('#taskbar').html(`${$('#taskbar').html()}<a class="${name}" onclick="minwin(\'${name}\')"><img src="/icons/${name}.png"></a>`);
