<template>
  <div>
    ...
    <div id="start-menu">
      ...
      <div id="s-m-l">
        ...
        <input
          ...
          class="input"
          alt="hi"
          placeholder="在这里输入你要搜索的内容"
          onclick="hide_startmenu();
      ...
      <div id="s-m-r">
        <div class="row1">
          <div class="folder">
            <a class="a sm-app"
              ><img src="/icons/folder/docs.png" />
              <p>文档</p></a
            >
            <a class="a sm-app"
              ><img src="/icons/folder/pics.png" />
              <p>图片</p></a
            >
            <a class="a sm-app"
              ><img src="/icons/folder/music.png" />
              <p>音乐</p></a
            >
          </div>
          <div class="tool">
            <p style="font-size: 40px; margin-bottom: -10px" class="time">
              12:00
            </p>
            ...
            <a class="a btn btn-icon power" onclick="$(this).addClass('show')">
              ...
              <i
                class="bi bi-power"
                onclick="$('#start-menu').removeClass('show');
						setTimeout(() => {window.location='shutdown.html';},200);"
              ></i>
              <i
                class="bi bi-arrow-counterclockwise"
                onclick="$('#start-menu').removeClass('show');
						setTimeout(() => {window.location='reload.html';},200);"
              ></i>
            </a>
            <a
              class="a btn btn-icon big"
              onclick="
        ...
        <div class="pinned">
          ...
          <div class="title">
            ...
            <div>
              <a class="a more-btn"
                >所有应用 <i class="bi bi-chevron-right"></i
              ></a>
              <!-- 这个好像没什么必要 -->
            </div>
          </div>
          <div class="apps">
            <a
              class="a sm-app enable"
              onclick="showwin('calc');hide_startmenu();"
            >
              <img src="/icons/calc.png" />
              <p>计算器</p></a
            >
            ...
            >
            <a
              class="a sm-app enable jump"
              href="https://github.com/tjy-gitnub/win12/issues"
              target="_blank"
            >
            ...
            <a
              class="a sm-app enable"
              onclick="showwin('about');hide_startmenu();"
              ><img src="/icons/about.png" />
              <p>关于Win12网页版</p></a
            >
            <a
              class="a sm-app enable"
              onclick="showwin('explorer');hide_startmenu();"
            >
              <img src="/icons/explorer.png" />
              <p>文件资源管理器</p></a
            >
            ...
            <a
              class="a sm-app enable"
              onclick="showwin('setting');hide_startmenu();"
            >
              <img src="/icons/setting.png" />
              <p>设置</p></a
            >
            <a class="a sm-app"
              ...
              <p>Microsoft Store</p></a
            >
            <a class="a sm-app"
              ><img src="/icons/taskmanager.png" />
              <p>任务管理器</p></a
            >
            <a class="a sm-app"
              ><img src="/icons/teams.png" />
              <p>Teams</p></a
            >
            <a class="a sm-app"
    ...
    <div id="search-win">
      ...
      <input-before class="bi bi-search"></input-before>
      <div class="tab">
        <a class="now">全部</a><a>应用</a><a>文档</a><a>网页</a> <a>电子邮件</a
        ><a>人员</a><a>设置</a><a>视频</a> <a>文件夹</a><a>音乐</a><a>照片</a>
      </div>
      <div class="ans">
        <div class="list">
          <list> 什么也没有 </list>
    ...
    <div class="window setting">
      <div class="titbar">
        <img src="/icons/setting.png" class="icon" />
        <p>设置</p>
        <div>
          <a class="a wbtg red" onclick="hidewin('setting')"
            ><i class="bi bi-x-lg"></i
          ></a>
          <a class="a wbtg max" onclick="maxwin('setting')"
            ><i class="bi bi-app"></i
          ></a>
          <a class="a wbtg" onclick="minwin('setting')"
      ...
      <div class="content" id="win-setting">
        <div class="menu">
          ...
          <input-before class="bi bi-search"></input-before>
          <list>
            <a style="background-color: var(--hover)"
              ><span
                style="
                  background-image: linear-gradient(180deg, #ad6eca, #3b91d8);
                  border-radius: 10px;
                  position: relative;
                  left: -10px;
                  top: 1px;
              ...
              >
                &nbsp;</span
              ><img src="/icons/setting/system.png" />系统</a
            >
            <a><img src="/icons/setting/blueteeth.png" />蓝牙和其他设备</a>
            <a><img src="/icons/setting/network.png" />网络和 Internet</a>
            <a><img src="/icons/setting/personal.png" />个性化</a>
            <a><img src="/icons/setting/apps.png" />应用</a>
            <a><img src="/icons/setting/user.png" />账户</a>
            <a><img src="/icons/setting/time.png" />时间和语言</a>
            <a><img src="/icons/setting/game.png" />游戏</a>
            <a><img src="/icons/setting/help.png" />辅助功能</a>
            <a><img src="/icons/setting/safe.png" />隐私和安全性</a>
            <a><img src="/icons/setting/update.png" />Windows 更新</a>
          </list>
        </div>
        <div class="page" style="overflow: auto">
          ...
          <div style="display: flex">
            <p
              class="s-icon"
              style="font-size: 70px; margin: -8px 10px 0px 20px"
            >
              
            </p>
            <div>
    ...
    <div class="window explorer">
      <div class="titbar">
        <img src="/icons/explorer.png" class="icon" />
        <p>文件资源管理器</p>
        <div>
          <a class="a wbtg red" onclick="hidewin('explorer')"
            ><i class="bi bi-x-lg"></i
          ></a>
          <a class="a wbtg max" onclick="maxwin('explorer')"
            ><i class="bi bi-app"></i
          ></a>
          <a class="a wbtg" onclick="minwin('explorer')"
            ><i class="bi bi-dash-lg"></i
          ></a>
        </div>
      </div>
      <div class="content" id="win-explorer">
        <div class="menu">
          <div class="card pinned">
            ...
            <list>
              <a><img src="/icons/explorer/qa.png" />快速访问</a>
              <a><img src="/icons/explorer/od.png" />OneDrive</a>
              <a class="check"
                ><span
                  style="
                  ...
                  "
                ></span>
                <img src="/icons/explorer/thispc.png" />此电脑</a
              >
              <a><img src="/icons/explorer/rb.png" />回收站</a>
            </list>
          </div>
          <div class="card tags">
        ...
        <div class="main">
          <div class="tool">
            <a class="a b t"><img src="/icons/explorer/tool-new.png" />新建</a>
            <div class="hr"></div>
            <a class="a b"><img src="/icons/explorer/tool-cut.png" /></a>
            <a class="a b"><img src="/icons/explorer/tool-copy.png" /></a>
            <a class="a b"><img src="/icons/explorer/tool-paste.png" /></a>
            <a class="a b"><img src="/icons/explorer/tool-rename.png" /></a>
            <div class="hr"></div>
            <a class="a b t"
              ><img src="/icons/explorer/tool-sort.png" />排序方式</a
            >
            <a class="a b t"><img src="/icons/explorer/tool-view.png" />布局</a>
          </div>
          <div class="content">
            <div class="tool">
              ...
              <p class="tit"><img src="/icons/explorer/thispc.png" />此电脑</p>
              <div class="search">
                <input
                  type="text"
                  class="input"
            ...
            <p class="title">此电脑</p>
            <p class="class">
              <img src="/icons/explorer/disk.png" /> 设备和驱动器
            </p>
            <div class="group">
              <a class="a item">
                <img src="/icons/explorer/diskwin.png" />
                <div>
              ...
              <a class="a item">
                <img src="/icons/explorer/disk.png" />
                <div>
    ...
    <div class="window calc">
      <div class="titbar">
        <img src="/icons/calc.png" class="icon" />
        <p>计算器</p>
        <div>
          <a class="a wbtg red" onclick="hidewin('calc')"
            ><i class="bi bi-x-lg"></i
          ></a>
          <a class="a wbtg max" style="pointer-events: none; color: #777"
            ><i class="bi bi-app"></i
          ></a>
          <a class="a wbtg" onclick="minwin('calc')"
            ><i class="bi bi-dash-lg"></i
          ></a>
        </div>
      </div>
      <div class="content" id="win-calc">
        ...
        <div class="keyb">
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value*=document.getElementById('calc-input').value"
            >𝑥²</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value=Math.sqrt(document.getElementById('calc-input').value)"
            >√𝑥</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value=''"
            >C</a
          >
          <a
            class="a b u"
          ...
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='7'"
            >7</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='8'"
            >8</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='9'"
            >9</a
          >
          <a
            class="a b u"
          ...
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='4'"
            >4</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='5'"
            >5</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='6'"
            >6</a
          >
          <a
            class="a b u"
          ...
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='1'"
            >1</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='2'"
            >2</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='3'"
            >3</a
          >
          <a
            class="a b u"
          ...
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value+='0'"
            >0</a
          >
          <a
            class="a b"
            onClick="document.getElementById('calc-input').value=document.getElementById('calc-input').value.substring(0,document.getElementById('calc-input').value.length-1);"
            ><i class="bi bi-backspace"></i
          ></a>
          <a
            class="a b ans u"
            onClick="document.getElementById('calc-input').value=eval(document.getElementById('calc-input').value)"
          >
            =</a
          >
        </div>
    ...
    <div class="window about">
      <div class="titbar">
        <img src="/icons/about.png" class="icon" />
        ...
        <div>
          ...
          <a class="a wbtg max" onclick="maxwin('about')"
            ><i class="bi bi-app"></i
          ></a>
          <a class="a wbtg" onclick="minwin('about')"
            ><i class="bi bi-dash-lg"></i
          ></a>
        </div>
      </div>
      <div class="content" id="win-about">
        <div class="menu">
          <list>
            <a
              onclick="$('#win-about>.about').show(200);$('#win-about>.update').hide();"
              ><img
                src="/icons/about/info.svg"
                height="17px"
                width="19px"
              />简介</a
            >
            <a
              onclick="$('#win-about>.update').show(200);$('#win-about>.about').hide();"
              ><img
                src="/icons/about/update.svg"
                height="20px"
                width="18px"
              />更新记录</a
            >
        ...
        <div class="cnt about">
          ...
          <div style="margin-left: 20px">
            ...
            <p>
              &emsp;&emsp;Windows 12 网页版是一个开源项目, 由谭景元原创,
              使用标准网络技术,例如 Html、CSS 和 Javascript,
              希望让用户在网络上预先体验 Windows 12。
            </p>
            <p>
              &emsp;&emsp;因为这只是概念版，所以内容可能与 Windows 12
              正式版本不一致。
            </p>
            <p>
              &emsp;&emsp;由于这是一个开源项目，你可以在任何媒介以任何形式复制、发行本作品。
              你还可以对该项目进行修改、转换或以本作品为基础进行创作。
              但您必须给出适当的署名，您必须提供创作者姓名、作品链接，同时标明是否对此作了修改。您可以用任何合理的方式来署名，但是不得以任何方式暗示许可方认可您或您的使用。
            </p>
            <p>
              &emsp;&emsp;此项目绝不附属于微软,且不应与微软操作系统或产品混淆,
              这也不是 Windows365 cloud PC
            </p>
            <p>
              &emsp;&emsp;本项目中微软、Windows和其他示范产品是微软公司的商标
            </p>
          </div>
          <div style="margin-left: 20px">
            <h2 class="tit"><span></span>其它</h2>
            <p>
              &emsp;&emsp;此项目已发布至 Github,
              <a href="https://github.com/tjy-gitnub/win12" class="jump"
                >点击此处查看</a
              >
            </p>
            <p>
              &emsp;&emsp;若您对于该项目有任何意见或建议，请在 Github 上<a
                href="https://github.com/tjy-gitnub/win12/issues"
                class="jump"
                >提交 issues</a
              >, 您的问题会被尽可能快地解决
          ...
          <div style="margin-left: 20px">
            <details>
              ...
              <p>
                ...
                &emsp;&emsp;-优化开始菜单固定项点击效果<br />
              </p>
            </details>

            <details>
              <summary><span>v1.1.4</span> 动画优化、显示时间</summary>
              <p>
            ...
            <details>
              <summary><span>v1.1.3</span> 列表 悬停、点击 效果</summary>
              <p>
                ...
                &emsp;&emsp;-使启动时不显示鼠标，更加逼真<br />
              </p>
            </details>

            <details>
              <summary><span>v1.1.2</span> 外观优化</summary>
              <p>
                &emsp;&emsp;-透明效果改善<br />
            ...
            <details>
              <summary><span>v1.1.1</span> 外观优化，修复了一些 Bug</summary>
              <p>
            ...
            <details>
              <summary><span>v1.1.0</span> 增加最小化功能,图标美化</summary>
              <p>
                ...
                &emsp;&emsp;-简化js关于拖动窗口的代码
              </p>
            </details>
            <details>
              <summary><span>v1.0.1</span> Bug和一些错别字</summary>
            ...
            <details>
              ...
              <p>
                ...
                &emsp;&emsp;-新增 "关于Win12网页版"
                应用，包含关于本项目的说明和历史更新记录<br />
                &emsp;&emsp;-优化开始菜单和搜索窗口的显示动画<br />
                &emsp;&emsp;-优化电脑端按钮的体验
              </p>
            </details>
          </div>
        </div>
